  ...
  return (
    <div className="flex flex-col" onClick={(e) => e.stopPropagation()}>
      <form className="text-white md:text-xl w-full" onSubmit={handleSubmit}>
        ...
        <input
          type="text"
          className="bg-zinc-900 border border-zinc-700 rounded-xl mt-2 py-2 px-3 w-full"
          onChange={updateName}
          value={name}
        />
        ...
        <textarea
          className="bg-zinc-900 border border-zinc-700 rounded-xl mt-2 w-full py-2 px-3 h-30 md:h-40"
          onChange={updateDetails}
          value={details}
        />
        <button
          type="submit"
          className={`flex text-white bg-blue-500 rounded-4xl w-full mt-4 md:mt-6 cursor-pointer py-3 items-center justify-center justify-self-center select-none ${
      ...
      <button
        className="mt-4 text-white border border-zinc-700 rounded-4xl py-2 pointer-events-auto cursor-pointer"

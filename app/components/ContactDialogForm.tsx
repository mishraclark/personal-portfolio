...
export default function ContactDialogForm(props: {onClose?: () => void}) {
  ...
  return (
    <div className="flex flex-col" onClick={(e) => e.stopPropagation()}>
        <form className="text-white text-xl w-full" onSubmit={handleSubmit}>
          ...
          <div className="text-xl text-white mt-6">Email</div>
          ...
          <div className="text-xl text-white mt-6">Details</div>
          <textarea className="bg-zinc-900 border border-zinc-700 rounded-xl mt-2 w-full py-2 px-3 h-40" onChange={updateDetails} value={details}/>
          <button type="submit" className={`flex text-white bg-blue-500 rounded-4xl w-full mt-6 cursor-pointer py-3 items-center justify-center justify-self-center select-none ${

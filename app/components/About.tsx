    ...
    >
      <div className="flex flex-col z-20 items-center justify-center w-full xl:mt-40 py-40 px-4 text-white lg:w-1/2">
        ...
        <p className="text-lg md:text-xl max-w-2xl text-center mb-8">
          Senior Frontend Engineer & Team Lead with expertise in React, Vue.js,
          and Web3 development, blending technical mastery with leadership in
        ...
        <div className="flex flex-col items-start">
          ...
          <ul className="list-disc pl-6 mb-8">
            <li>
              Led frontend development for Calaxy (founded by Spencer Dinwiddie
              and Solo Ceesay), architecting the platform's core features as
              both an agency contractor and later as Senior Frontend
              Engineer/Team Lead.
            </li>
            <li>
              Directed sprints, mentored junior developers, and bridged
              design-backend gaps to ship high-impact features.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 mb-8">
            ...
            <ul className="list-disc pl-6">
              <li>
                Web3: Developed wallets, nft minters, and token auction
                platforms
              </li>
          ...
          <ul className="list-disc pl-6 mb-8">
            <li>
              {
                "Technical: Optimized performance (Lighthouse scores >90), implemented CI/CD, and pioneered reusable component libraries."
              }
            </li>
            <li>
              Leadership: Translated complex tech concepts for non-technical
              stakeholders (executives, designers, partners).
            </li>
          </ul>
        </div>
      </div>

...
export default function Intro(props: { onOpenDialog: () => void }) {
  ...
  return (
    <div className="flex flex-col">
      <div
        className={`flex lg:max-xl:flex-col md:max-lg:flex-row md:mt-[92px] justify-between ${scrollY > headerOffset ? "mt-[104px] md:mt-[200px]" : "mt-10 md:mt-[92px]"}`}
      >
        <div className="flex max-[1400px]:flex-col">
          <div className="flex flex-col z-100 text-center items-center md:items-start md:text-left">
            ...
            <div className="text-zinc-500 mt-6 md:mt-10 md:w-[356px] md:text-xl">
              I am a Senior Software Engineer specializing in React, Vue.js, and
              Web3 development. From small business websites to enterprise
              fintech applications, I excell at building solutions that are
              high-performance, user-centric, and secure.
              <br />
              <br />
              Interested in launching a new product, or elevating an existing
            ...
            <div className="flex gap-4 mt-8 md:mt-10">
              <button
                type="button"
                className="pointer-events-auto cursor-pointer px-6 py-3 text-white bg-slate-900 border border-slate-700 rounded-xl"
                onClick={props.onOpenDialog}
              >
                Contact
              </button>
              <a
                href="app/documents/MishraClarkResume.pdf"
                download="MishraClarkResume.pdf"

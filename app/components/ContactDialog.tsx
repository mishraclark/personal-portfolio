...
export default function ContactDialog(props: {
  ...
  return props.open ? (
    <div
      className="fixed inset-0 flex items-center justify-center z-100 bg-[#00000090]"
      onClick={props.onClose}
    >
      <div
        className="bg-zinc-950 border border-zinc-900 p-6 rounded-lg shadow-lg flex flex-col m-4"

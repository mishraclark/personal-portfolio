export default function Contact(props: {onOpenDialog: () => void}) {
    return (
      <div className="flex flex-col mt-20 lg:mt-[100px] py-20 px-10 items-center text-center">
        ...
        <div className='flex flex-col items-center justify-center text-white max-w-120'>
            ...
            <button type="button" className="pointer-events-auto cursor-pointer mt-10 px-10 py-4 text-lg text-amber-200 border-amber-200 border rounded-xl -scroll-mt-20" onClick={props.onOpenDialog}>
                Say Hello 
            </button>
        </div>
